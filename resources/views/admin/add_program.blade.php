...
<html lang="en">
    ...
    @include('admin.navbar2')
        ...
        <script src="admin new/js/scripts.js"></script>
        <script src="https://cdnjs.cloudflare.com/ajax/libs/Chart.js/2.8.0/Chart.min.js" crossorigin="anonymous"></script>
        <script src="admin new/assets/demo/chart-area-demo.js"></script>
        <script src="admin new/assets/demo/chart-bar-demo.js"></script>
        <script src="https://cdn.jsdelivr.net/npm/simple-datatables@latest" crossorigin="anonymous"></script>
        <script src="admin new/js/datatables-simple-demo.js"></script>
    </body>
</html>
